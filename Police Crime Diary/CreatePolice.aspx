<%@ Page Language="C#" Title="Create Police" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatePolice.aspx.cs" Inherits="Police_Crime_Diary.CreatePolice" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container rounded p-5" id="page-1" style="background-color: white;">
        <div class="mb-4">
            <h4 class="border-bottom py-2 mb-2">Police Form <a href="~/Police.aspx" runat="server" class="btn btn-sm btn-info float-end">View Police List</a></h4>
        </div>
        ...
        <div class="row p-0 mb-2">
            ...
            <div class="col-7 p-0 mx-2 text-end">
                ...
                <img src="#" alt="Uploaded Image" id="image" style="width: 100px; height: 150px;" />
            </div>
        </div>
    ...
    <div class="container rounded p-3" style="display: none; background-color: white;" id="second">
        ...
        <div class="row p-0 mb-2">
            ...
            <div class="col-offset-4 col-7 p-0 mx-2 text-start">
                ...
                <asp:Button ID="register" runat="server" CssClass="btn btn-success mt-2" OnClick="register_Click" Text="Create Police" />
            </div>
        </div>
    </div>
